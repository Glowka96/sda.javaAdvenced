...
import static object.task.post.Status.*;
...
public class PostOffice {
    ...
    public int printWeightOrNumberSt() throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
 ...
 /*   public Letter createLetter() throws IOException {
        System.out.println("Enter sender's name:");
        Address address = new Address();
        //String address = printNameOrStreet();
        System.out.println("Enter addressee's name:");
        String sendAddress = printNameOrStreet();
        System.out.println("Enter priority package: ");
        boolean isPriority = isPriority();
        System.out.println("Enter weight package: ");
        int weight = printWeightOrNumberSt();
        //return new Letter(address, sendAddress, weight, isPriority);
    }*/
